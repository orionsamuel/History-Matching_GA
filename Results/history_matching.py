...
print("MAPE Error Water: ", mean_absolute_percentage_error(real_water, water))
print("R² Error Water: ", r2_score(real_water, water))
print("")
print("MAPE Error Oil: ", mean_absolute_percentage_error(real_oil, oil))
print("R² Error Water: ", r2_score(real_oil, oil))
